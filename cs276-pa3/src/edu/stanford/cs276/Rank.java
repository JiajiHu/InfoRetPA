...
public class Rank {
  ...
  private static Map<Query, List<String>> score( Map<Query, Map<String, Document>> queryDict, String scoreType, Map<String, Double> idfs) {
    ...
    if (scoreType.equals("baseline"))
      ...
      // feel free to change this to match your cosine scorer if you choose to
  ...
  // this probably doesn't need to be included, but if you output to a file, it
  // may be easier to immediately run ndcg.java to score your results
